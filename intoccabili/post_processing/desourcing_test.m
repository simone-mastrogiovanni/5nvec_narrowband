...
% This function compute the desourcing tests for two gd. The gd can either
% be BSD or normal one, the important is that they are not corrected.
% ggnames: Name of the BSD that contains the outliers
% name_H: Name of the of the gd in BSD file for the I IFO
% name_L: Name of the of the gd in BSD for the II IFO
% ant_H: First IFO
% ant_L: Second IFO

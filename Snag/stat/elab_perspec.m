...
map=gd2(M1');
map=edit_gd2(map,'ini',inifr,'dx',dfr,'dx2',dh);
...
title([capt ' - phase-frequency epoch-folding map']),ylabel('Hours'),xlabel('Frequency (days^{-1})')
...
title([capt ' - phase-frequency epoch-folding spectrum']),ylabel('Amplitude'),xlabel('Frequency (days^{-1})');
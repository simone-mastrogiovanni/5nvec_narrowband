...
%------------------------------------------------------------------------------
% obliquity function                                                     ephem
% Description: Calculate the obliquity of ecliptic, with respect to the mean
%              equator of date, for a given julian day.
...
% Example: Obl=obliquity(2451545+[0:1:5]).';
% Reliable: 1
%------------------------------------------------------------------------------

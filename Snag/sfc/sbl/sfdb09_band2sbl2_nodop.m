function [gdout g0 g45 iok sbl_ dt0all phall phall1]=sfdb09_band2sbl2_nodop(freq,cont,folder,pialist,filesbl,simpar,dtout)
%SFDB09_BAND2SBL  puts in a sbl files a band of sfdb09
%     the output file is single, except in the case of whole band
%
%    [gdout iok sbl_ dt0all phall phall1]=sfdb_band2sbl2_nodop(freq,cont,folder,pialist,filesbl,simpar,dtout)
%
...
%                         st=gmst(mjd)+dtori*(0:lfftori-1)/3600+antenna.long/15;
                        ...
                        stsub=gmst(mjd)+dtori*(0:nsampsec:lfftori-1)/3600;
                        ...
                        if ic045 > 0
                            ...
                            pars.time(2,kchunk)=mjd;
                            pars.time(1,kchunk)=deltat;
                        end

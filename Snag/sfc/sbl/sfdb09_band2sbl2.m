function [gdout g0 g45 iok sbl_ dt0all phall phall1]=sfdb09_band2sbl2(freq,cont,folder,pialist,filesbl,simpar,dtout)
...
%                 if in list a line has a ! at beginning, it is neglected

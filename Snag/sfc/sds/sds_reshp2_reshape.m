function sds_reshp2_reshape(listin,maxndat,frout,hpfr1,hpfr2,nsec,folderin,folderout)
...
%   hpfr1,2     high-pass frequency band (hpfr1<hpfr2)
...
for i = 1:nfiles
    ...
    if i == 1
        ...
        fr1=hpfr1*dt;
        fr2=hpfr2*dt;
        hlp=hlp_frfilt(ndat1*2,fr1,fr2,2);
        figure,semilogy(abs(hlp)),grid on;
    ...
    while indata > 0
        ...
        if indata > 0
            ...
            for k = 1:nch
                ...
                x0(1:ndat1)=x0(1:ndat1).*hlp(1:ndat1)';

function out=aa_supersamp(in,lpin,lpout)
%AA_SUPERSAMP  anti-aliasing super-sampling
%
%    in     input vector
%    out    output vector
...
while nou2 < nout
	...
	IN1=fft(in1);
    OUT1=zeros(1,lpout);
	OUT1(1:lpin2)=IN1(1:lpin2);
	OUT1(lpin2)=OUT1(lpout2)*0.25;
	OUT1(lpin2-1)=OUT1(lpin2-1)*0.5;
	OUT1(lpin2-2)=OUT1(lpin2-2)*0.75;
	OUT1(lpout:-1:lpout+2-lpin2)=conj(OUT1(2:lpin2));
	out1=ifft(OUT1);

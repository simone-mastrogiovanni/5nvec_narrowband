function ya=ar_lowpass_cheb(in,fr,norm)
% AR_LOWPASS  low-pass of input, various normalizations with Chebyshev
%             8-order filter, 3 dB ripple
%

function [sids,bsdsstr]=sid_sweep_couple(bsdsstr,freq,direc,sband,iout,nsid)
% antenna couples sid_sweep candidates
%
%   sids=sid_sweep_ref_couple(bsdsstr,freq,direc,sband,nsid)
%

function [bsd_out,BSD_tab_out,out]=bsd_access_lm(addr,ant,runame,tim,freq,mode,modif,modifpost)
% data access with low memory constraint
%
%     [bsd_out,BSD_tab_out,out]==bsd_access_lm(addr,ant,run,tim,freq,mode,modif,modifpost)
%
...
% Snag Version 2.0 - September 2018
% Part of Snag toolbox - Signal and Noise for Gravitational Antennas
% by S.D'Antonio, O.J.Piccinni, S. Frasca - sergio.frasca@roma1.infn.it
...
if mode == 21 % done always 
    inifr1=freq(1);
    bandw1=freq(2)-freq(1);
    [ort,inifr,bandw,dt]=bsd_orthoband(inifr1,bandw1,dt0);
    freq(1)=inifr;
    freq(2)=inifr+bandw;

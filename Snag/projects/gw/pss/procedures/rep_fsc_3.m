...
fake_source_file='K:\pss\metadata\FakeSources\sourcefile1.dat';

[fake_source sour]=pss_readsourcefile(fake_source_file);
...
figure
semilogy(fake_source(1,:),fake_source(7,:),'o'),hold on
...
figure
plot(fake_source(2,:),fake_source(3,:),'o'),hold on
...
hold on,plot(fake_source(1,:),log(fake_source(7,:))*0.0005+0.002,'ro')
ylim([-.003,.003])
title('Detection error')
xlabel('frequency')
...
psc_faketable(c_cand1,c_cand2,fake_source);

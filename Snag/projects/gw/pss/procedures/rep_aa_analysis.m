...
spstr.typ=2;
spstr.xlabel='frequency';
spstr.ylabel='power spectrum';
spstr.xlim=[];
spstr.ylim=[];

%% Benoit's observation
% 
...
plot_gd(spstr,ss5a);
spstr.xlim=[639.5 640.5];
spstr.ylim=[10^-10 100];
plot_gd(spstr,ss5a);
spstr.xlim=[];
spstr.ylim=[];

%% Passuelo's observation
% Passuelo
...
%% Ramp example (the most meaningful)
% ramp

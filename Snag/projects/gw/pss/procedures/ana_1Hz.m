function [tsol tsid sp1 par sp gin]=ana_1Hz(fr,str,thr,band,SM,long,ic)
%
...
eval(['load ' str str1])
eval(['gin=' str str1 ';']);%['gin=' str str1 ';'],gin
n=n_gd(gin);
par.band=band;
par.n0=n;
...
if length(ic) > 1
    ...
    if ic == 1 
        sp=gd_pows(gin,'pieces',1000,'window',2,'resolution',2);
    else
        close
        sp=0;
    end

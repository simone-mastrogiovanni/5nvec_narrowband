function [h_eff,sens,dist,med]=tune_effect_bg(chn,x,y)
%TUNE_EFFECT_BG to be used before effect_bg in order to tune it
%                   to exclude erroneously too low spectra
%                   checking the plot of med
%
%         [h_eff,sens,med]=tune_effect_bg(chn,x,y)
% 

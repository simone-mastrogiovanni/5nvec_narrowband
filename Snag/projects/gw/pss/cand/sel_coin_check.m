function [h1 h2]=sel_coin(coin,crit,ncand,lists)
%
%     [selind bsel spotind]=sel_coin(coin,crit,ncand,lists)
%
...
%
% ex: [selind bsel spotind]=sel_coin(coin_1_100110_ref,{[1,0.3 1],[2,0.8],[3,0.05 0 1],[10,1],[12,1.0],[20 1]},2);
%
% ex. sel sour: [selind bsel spotind]=sel_coin(coin_1_050060_ref,{[1,0.3 1],[2,0.9],[3,0.10,0,1],[10,1],[13,52.80,52.816],[20 1]},30);
...
N1=coin.clust1(1,:);
N2=coin.clust2(1,:);
r1=ceil(rand(1,length(n1))*length(N1));
r2=ceil(rand(1,length(n2))*length(N2));

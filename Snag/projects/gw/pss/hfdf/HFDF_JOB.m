function [cand,job_summary,check]=HFDF_JOB(job_pack_0,job_pack,outdir)
...
for i = 1:M
    ...
    [hfdf,job_info]=hfdf_hough(pout,basic_info,job_info,hm_job);
    [cand0,job_info]=hfdf_peak(hfdf,basic_info,job_info,kcand);
    [cand1,job_info]=hfdf_refine(cand0,basic_info,job_info,pout,patch);

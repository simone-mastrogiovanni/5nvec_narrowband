function [hfdf,job_info,checkE]=hfdf_houghMEX(peaks,basic_info,job_info,hm_job)
...
%       oper=' adaptive';
    ...
    case 'onlysigadapt'
        %usata con patch_nostro peaks5 e' gia' il radpat normalizzato.
        %30/09/2014
       % % peaks(5,:)=peaks(5,:)./peaks(4,:);
       %   peaks(5,:)=peaks(5,:)/mean(peaks(5,:));
end
...
%binh_df0 = coreHoughDyn_mex(peaks,inifr,ddf,Day_inSeconds,deltaf2,ii0,ii,nbin_d,d,I500,nTimeSteps,nbin_f0);

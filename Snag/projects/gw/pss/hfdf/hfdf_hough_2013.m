function [hfdf,job_info,checkE]=hfdf_hough(peaks,basic_info,job_info,hm_job)
...
job_info.proc.E_hfdf_hough.vers='140630';
...
hfdf=gd2(binh_df0.');
hfdf=edit_gd2(hfdf,'dx',ddf,'ini',inifr,'dx2',deltad,'ini2',dmin1,'capt','Histogram of spin-f0');

...
MAXLOOP=1 %10   %number of loops around the true spin-down
...
dmin=dmin+0.5*deltad
% dmin=round(dmin/deltad)*deltad
...
peaks(2,1:n_of_ff)=ff;
peaks(1,1:n_of_ff)=tim_tot;
...
hmap.d=[dmin deltad nbin_d];

hdf0=hfdf_hough(hmap,peaks); plot(hdf0)

thres=20;
[xp,yp,zp]=twod_peaks(hdf0,thres,1,1)
function piapeak2vbl_3(dfr,lfft,piafile,filout)
% format transformation 3 -> 3 values
%
%   piapeak2vbl_3(2000/2^21,2^22)
%
% Pia-Peak format:
%
%     Header
...
vbl_.ch(4).capt='MEANAMP mean amplitude';
...
for i = 1:nfft
    ...
    blocklength=32+60*4+3*8+nmax*(4+4+4); % head + ch head + vel + specs

function [g vv pp tim par1 par2 par3]=pss_band_recos_fastres(source,filein,dtout,tref,gdname,tint)
% PSS_BAND_RECOS_FASTRES  band reconstruction from a reduced band sfdb file
%                         (fast resampling method)
%
%      [g vv pp tim par1 par2 par3]=pss_band_recos_fastres(source,filein,dtout,tref,gdname,tint)
%
...
%         t2=t1;
    ...
    [out iout in p]=pss_fd_fastres(in,t1);

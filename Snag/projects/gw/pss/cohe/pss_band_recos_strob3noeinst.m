function [g vv pp tim par1 par2 par3]=pss_band_recos_strob3noeinst(source,filein,dtout,tref,gdname,tint)
% PSS_BAND_RECOS_STROB  band reconstruction from a reduced band sfdb file
%                         (stroboscopic method)
%
%        g=pss_band_recos_strob3(source,filein,dtout,tref,gdname,tint)
%
...
%         t2=t1;
    ...
    [out iout p]=pss_fd_resamp3noeinst(t1);

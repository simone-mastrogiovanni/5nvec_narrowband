function [c_cand1,c_cand2]=psc_coin_db3(dircand1,dircand2,freq,searstr,resfile)
%PSC_COIN_DB3  finds coincidences in psc-db (type 3)
%      IN CONSTRUCTION - NOT YET READY
%   [c_cand1,c_cand2]=psc_coin_db3(dircand1,dircand2,nfreq,searstr,resdir)
%
...
%  resfile      result file
%
% type-3 psc-db is in files of 10 Hz, each group in single spin-down files

function psc_coin_single(dircand1,dircand2,searstr,resdir)
%PSC_COIN_SINGLE  finds coincidences in psc-db (type 2)
%
%   psc_coin_single(dircand1,dircand2,searstr,resdir)
%
...
for k = 1:242
    ...
    dir1=dir(filtot1);
    len1=floor(dir1.bytes/14);
    dir2=dir(filtot2);
    len2=floor(dir2.bytes/14);

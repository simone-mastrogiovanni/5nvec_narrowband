function [d,r,r_struct]=db_gods(d,r,g,ntype,file,chs,chn,fid,reclen,r_struct,sp)
%DB_GODS  ds client
%
%        [d,r,r_struct]=db_gods(d,r,g,ntype,file,chs,chn,fid,reclen)
%
%        d       the ds
...
switch ntype
case 1
   [d,r_struct]=sds2ds(d,r_struct,chn);
case 2

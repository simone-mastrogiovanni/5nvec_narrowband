function [d,r,fid,reclen,g,r_struct]=db_open(ntype,file,chs,dslen1,dstype,rglen,dt0,sp,frame4par)
%DB_OPEN  creates a ds and an rg, opens an R87 file, creates a gd for matlab files
%
%        [d,r,fid,reclen,g,r_struct]=db_open(ntype,file,chs,dslen,dstype,rglen,dt0,sp,frame4par)
%
...
case 1
    d=ds(dslen);
    d=edit_ds(d,'type',dstype);
    
    r_struct=sds_open(file);
    d=edit_ds(d,'dt',r_struct.dt);
case 2

...
frame4par.nframe=fread(fid,1,'uint32'); % count=frame4par.nframe
...
if ok == 0
   ...
   if id_1 == cid_1 & id_2 == cid_2
      ...
      frame4par.compress(i)=fread(fid,1,'uint16'); %Read compression type
   ...
   if indselc == 30
       selc=1;
       fprintf('FILE READING ERROR POSITION: %d',frame4par.distch(1));
       return
   end

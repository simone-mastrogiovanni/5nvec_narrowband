function fmnl_readfrsimd(fid,len,class,swp)

% FMNL_READFRSIMD  Reads Simulated Data Structure. Used by FMNL_EXPLOREFR4
%
%                  fid -> file identifier 
...
namesd=fmnl_read_string(fid);
commn=fmnl_read_string(fid);
samps=fread(fid,1,'float64');

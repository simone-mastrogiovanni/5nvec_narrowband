...
title('sorgente sferica')
figure;loglog(x,y);hold on,loglog(x,yy,'g');grid on
title('sorgente sferica')
...
title('sorgente a mattone')
figure;loglog(x,y1);hold on,loglog(x,yy,'g');grid on
title('sorgente a mattone')
...
title('due sorgenti puntiformi')
figure;loglog(x,y2);hold on,loglog(x,yy,'g.');grid on
title('due sorgenti puntiformi')
...
static mxArray S5_ = mccCINIT( mccTEXT,  1, 29, S5__r_, 0);
/* static array S6_ (1 x 11) text, line 198: '%f %f %f \n' */
static unsigned short S6__r_[] =
{
         37,  102,   32,   37,  102,   32,   37,  102,
         32,   92,  110,
};
static mxArray S6_ = mccCINIT( mccTEXT,  1, 11, S6__r_, 0);
/* static array S7_ (1 x 11) text, line 202: '%f %f %f \n' */
 ...
 *       emax        	real scalar
 *       event_finder	<function being defined>
 *       exp         	<function>
 *       fclose      	<function>
 *       fidev       	real vector/matrix
 *       fidev       	integer scalar  => fidev_1
 *       fidev       	real scalar  => fidev_2
 *       fidst       	real vector/matrix
 ...
 *       scratchdata 	real vector/matrix
 *       snag_local_symbols	<function>
...
)
{
...

   {
      ...
      /* snag_local_symbols; */
      Mplhs_[0] = 0;
      mccCallMATLAB(0, Mplhs_, 0, Mprhs_, "snag_local_symbols", 66);
      /* fidev=[scratchdata fileev]; */
      mccUndefVariable(&scratchdata, &S0_);
      if(mccNOTSET(&fileev))
      {
         mexErrMsgTxt( "variable fileev undefined, line 67" );
      }
      mccCatenateColumns(&fidev, &scratchdata, &fileev);
      /* fidst=[scratchdata filest]; */
      if(mccNOTSET(&filest))
      {
         mexErrMsgTxt( "variable filest undefined, line 68" );
      }
      mccCatenateColumns(&fidst, &scratchdata, &filest);
      ...
      if (( ((mccPR(&stat)[(5-1)]) == 0) && !mccREL_NAN((mccPR(&stat)[(5-1)])) ))
      {
         ...
         fidev_1 = mccImportReal(0, 0, Mplhs_[ 0 ], 1, " (event_finder, line 78): fidev_1");
         /* fidst=fopen(fidst,'w'); */
         Mprhs_[0] = &fidst;
         Mprhs_[1] = &S2_;
         Mplhs_[0] = 0;
         mccCallMATLAB(1, Mplhs_, 2, Mprhs_, "fopen", 79);
         fidst_1 = mccImportReal(0, 0, Mplhs_[ 0 ], 1, " (event_finder, line 79): fidst_1");
         /* stat(21)=fidev; */
      ...
      else
      {
         ...
         fidev_1 = mccImportReal(0, 0, Mplhs_[ 0 ], 1, " (event_finder, line 83): fidev_1");
         /* fidst=fopen(fidst,'a'); */
         Mprhs_[0] = &fidst;
         Mprhs_[1] = &S4_;
         Mplhs_[0] = 0;
         mccCallMATLAB(1, Mplhs_, 2, Mprhs_, "fopen", 84);
         fidst_1 = mccImportReal(0, 0, Mplhs_[ 0 ], 1, " (event_finder, line 84): fidst_1");
         /* end */
      }

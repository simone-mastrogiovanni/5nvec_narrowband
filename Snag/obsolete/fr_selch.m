function [chn,chs,dt,dlen,sp,vers,minvers,frame4par]=fr_selch(ntype,file)
%FR_SELCH  channel selection for frames and R87 files
%
%        [chn,chs,dt,dlen,sp,vers,minvers,frame4par]=fr_selch(ntype,file)
%

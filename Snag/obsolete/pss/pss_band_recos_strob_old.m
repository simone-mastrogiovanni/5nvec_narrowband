function [g vv pp tim par1 par2 par3]=pss_band_recos_strob(source,filein,dtout,gdname,tint)
...
%         fprintf(fidlog,'stin = %15.9f \n',stin);
        ...
        if icsource == 1
            ...
            pars.alpha=sour1.a;
            pars.delta=sour1.d;
            fprintf(fidlog,'  new frequency, spin down: %20.14f %e \n',source.f0,source.df0);
        else
            f0=source(1);
            df0=source(2);
            ddf0=source(3);
...
%         t2=t1;
    ...
    [out iout in p]=pss_fd_resamp(in,t1);

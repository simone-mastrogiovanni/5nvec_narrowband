function [clust,prog,prog1,index,index1,serv1,serv]=cand_clust_3(A,dist,dfr,dsd)
...
tic
disp('find_clust 1'),size(A)
[serv,index,prog]=find_clust(1,A,dist,dfr,dsd);
toc
...
tic
disp('find_clust 1'),size(A)
[serv1,index1,prog1]=find_clust(-1,A,dist,dfr,dsd);
toc
...
function [serv,index,prog]=find_clust(direc,A,dist,dfr,dsd)
...
if direc == -1
    prog=n1-prog(ncl:-1:1)+1;
    index=ncl-index(n1:-1:1)+1;
end
